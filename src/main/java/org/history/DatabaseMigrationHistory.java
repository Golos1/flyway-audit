...
public class DatabaseMigrationHistory implements Callback {
    ...
    public void handle(Event event, Context context) {
        ...
        try (Statement statement =  context.getConnection().createStatement();PreparedStatement insertStatement = context.getConnection().prepareStatement("INSERT INTO FlywayMigrations (Description, Type, ApproximateTime) " +
